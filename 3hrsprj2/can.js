...
async function getData() {
  try {
    const res = await axios.get("https://crudcrud.com/api/d9fbec79643640e09a55508487ebf48d/candies");
...
sbmt.addEventListener('click', async (sub) => {
  ...
  try {
    const resp = await axios.post("https://crudcrud.com/api/d9fbec79643640e09a55508487ebf48d/candies", obj);
    ...
    by1.addEventListener('click', async (buy) => {
        if (data.quantity >= 1) {
          ...
          try {
            ...
            {
              // axios.delete()
              await axios.delete(`https://crudcrud.com/api/d9fbec79643640e09a55508487ebf48d/candies/${data._id}`);  
              location.reload();
            }
            else{
                await axios.put(`https://crudcrud.com/api/d9fbec79643640e09a55508487ebf48d/candies/${data._id}`, objnew);
